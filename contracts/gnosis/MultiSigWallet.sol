...
contract MultiSigWallet {
     ...
     */
    modifier onlyWallet() {
        require(msg.sender == address(this),"call should be invoked from WALLET contract!");
        _;
    }
    ...
    modifier transactionExists(uint transactionId) {
        require(transactions[transactionId].destination != address(0),"transaction is not exits!");
        _;
    }
